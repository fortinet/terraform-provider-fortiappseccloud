...
func ResourceOpenApiValidation() *schema.Resource {
	return &schema.Resource{
		Create: resourceWAFOpenApiValidationUpdate,
		Read:   resourceWAFOpenApiValidationRead,
		Update: resourceWAFOpenApiValidationUpdate,
		Delete: resourceWAFOpenApiValidationDelete,
...
func resourceWAFOpenApiValidationRead(d *schema.ResourceData, m interface{}) error {
...
func resourceWAFOpenApiValidationUpdate(d *schema.ResourceData, m interface{}) error {
	c := m.(*WAFClient).CloudClient
	if c == nil {
		return fmt.Errorf("WAF client did not initialize successfully!")
	}
...
func resourceWAFOpenApiValidationDelete(d *schema.ResourceData, m interface{}) error {
	c := m.(*WAFClient).CloudClient
	if c == nil {
		return fmt.Errorf("WAF client did not initialize successfully!")
	}
